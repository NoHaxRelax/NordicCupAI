...
| A11 | Jammer, condor, spacecraft never measured on a real unseen instance | unknown | | MEASURED Sunday 03:30 on unseen terrain with exact labels (`scene_malmi25`, Oscar's synthetic flight, F3, deploy switches): condor 1.000 on 37 boxes, jammer 0.881 on 44, spacecraft 0.851 on 40. Same Helsinki sprites as our training set, so this covers new terrain and placement, not a new instance of the object | absent from validation; `research/07-committee.md` finding 6 |
