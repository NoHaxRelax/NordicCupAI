...
`elias/sprites/bank.json` (169 GrabCut sprites, see `elias/data/sprites.py`). Every number below was
...
3. Tall objects (large tower above all, then small tower, ta-ta, medium launcher, hangar, the erected large
   ...
   15 degrees on all 9 pairs with matched view angle (section 2c). A rotation that makes the lean point
...
best pose is reported as well. 110 pairs, 71 s on CPU.
...
|---|---|---|---|
| same track, neighbouring frames (ceiling) | 33 | 0.743 | 0.21 to 0.94 |
| same track, top against bottom of the frame (view angle only) | 32 | 0.602 | 0.24 to 0.88 |
| different tracks, same scene, matched view angle (heading change) | 13 | 0.604 | 0.22 to 0.79 |
| helsinki against validation, matched view angle | 16 | 0.510 | 0.20 to 0.73 |
| different classes (what a 360 degree search reaches by chance) | 16 | 0.286 | 0.05 to 0.42 |
...
|---|---|---|---|---|---|---|---|
| small_tower | val c f157 -> f164 | 37.1 -> 31.0 | +5 | +1 | 0.88 | 0.86 | 0.94 |
| hangar | hel f22 -> f24 | 43.7 -> 42.7 | +2 | 0 | 0.87 | 0.97 | 0.84 |
| small_tower | val b f240 -> f249 | 36.0 -> 27.2 | -3 | 0 | 0.86 | 0.84 | 0.86 |
| tank | val c f195 -> f206 | 25.3 -> 13.4 | +20 | 0 | 0.79 | 0.80 | 0.79 |
| condor | hel f0 -> f8 | 18.5 -> 14.9 | -35 | -1 | 0.73 | 0.86 | 0.91 |
| small_plane | hel f0 -> f7 | 10.4 -> 2.6 | -52 | -1 | 0.72 | 0.82 | 0.74 |
| medium_plane | hel f21 -> f24 | 41.3 -> 39.4 | +3 | -1 | 0.72 | 0.83 | 0.75 |
| tank | hel f1 -> f24 | 39.8 -> 23.6 | +35 | -2 | 0.69 | 0.78 | 0.85 |
| spacecraft | hel f0 -> f21 | 26.8 -> 7.6 | +73 | 0 | 0.67 | 0.71 | 0.86 |
| tank | val 015-036 f15 -> f36 | 37.1 -> 15.4 | -15 | 0 | 0.66 | 0.85 | 0.74 |
| small_tower | hel f8 -> f18 | 19.1 -> 14.1 | -43 | -14 | 0.66 | 0.70 | 0.92 |
| tank | val d f30 -> f61 | 36.7 -> 6.4 | -81 | +6 | 0.63 | 0.67 | 0.74 |
| helicopter | val b f107 -> f137 | 40.9 -> 25.6 | +57 | +2 | 0.62 | 0.43 | 0.78 |
| jet_plane | hel f4 -> f24 | 36.9 -> 16.8 | -14 | +3 | 0.62 | 0.75 | 0.78 |
| jammer | hel f0 -> f11 | 16.5 -> 7.7 | +59 | +1 | 0.62 | 0.87 | 0.79 |
| mine_roller | val b f197 -> f206 | 36.7 -> 28.1 | +1 | +3 | 0.60 | 0.86 | 0.62 |
| large_launcher | hel f0 -> f18 | 39.4 -> 31.2 | -30 | -3 | 0.55 | 0.74 | 0.61 |
| jet_plane | val d f54 -> f82 | 37.1 -> 13.5 | +59 | +4 | 0.54 | 0.68 | 0.75 |
| hangar | val 103-148 f112 -> f131 | 37.2 -> 20.5 | -25 | 0 | 0.53 | 0.88 | 0.63 |
| tank | val b f129 -> f160 | 37.9 -> 14.1 | +73 | 0 | 0.53 | 0.63 | 0.70 |
| large_tower | hel f7 -> f24 | 43.0 -> 33.5 | -22 | -12 | 0.48 | 0.60 | 0.81 |
| ta-ta | hel f0 -> f24 | 34.8 -> 17.0 | +51 | +3 | 0.46 | 0.61 | 0.75 |
| helicopter | val b-early f85 -> f104 | 35.2 -> 14.6 | +9 | -6 | 0.45 | 0.44 | 0.70 |
| medium_launcher | val a f92 -> f123 | 36.4 -> 0.6 | +87 | no match (-161) | 0.40 | 0.41 | 0.56 |
| large_tower | val c f218 -> f239 | 41.5 -> 29.1 | +30 | +24 | 0.32 | 0.67 | 0.51 |
| large_tower | val b f93 -> f122 | 36.1 -> 2.2 | +33 | no match (-173) | 0.27 | 0.54 | 0.21 |
| hangar | val 053-082 f56 -> f82 | 37.2 -> 15.7 | +50 | -4 | 0.26 | 0.78 | 0.65 |
| large_launcher | val d f196 -> f226 | 36.0 -> 3.3 | -74 | -8 | 0.24 | 0.66 | 0.78 |
| small_launcher | 4 tracks | | | -90 to +151 | 0.40 to 0.60 | 0.25 to 0.57 | 0.56 to 0.72 |
...
direction (-12 and +24 measured against -22 and +30 predicted) and at the bottom of the frame it is seen
...
16 degrees (val 053-082: NCC 0.26 with IoU 0.78, so the roof outline stays and the bright details go).
Large launcher, validation track d: at 36 degrees the raised canister and the cab are seen from the side,
at 3 degrees the vehicle is a flat long strip with outriggers (NCC 0.24, IoU 0.66, against 0.78 between
neighbouring frames). The helsinki launcher only covers 39 to 31 degrees and keeps 0.55.
...
|---|---|---|---|---|---|---|---|---|---|
| tank | val 015-036 f15 -> val b f129 | 37.1 / 37.9 | 343 | 0.63 | 0.87 | 0.37 | 0.32 | 26 | 0.23 |
| tank | val 015-036 f36 -> val c f206 | 15.4 / 13.4 | 220 | 0.63 | 0.80 | 0.20 | 0.36 | 60 | 0.36 |
| tank | val 015-036 f15 -> val d f30 | 37.1 / 36.7 | 140 | 0.55 | 0.72 | 0.23 | 0.34 | 0 | 0.23 |
| tank | val b f160 -> val c f206 | 14.1 / 13.4 | 242 | 0.62 | 0.84 | 0.18 | 0.36 | 306 | 0.13 |
| tank | val b f129 -> val d f30 | 37.9 / 36.7 | 162 | 0.50 | 0.68 | 0.19 | 0.36 | 334 | 0.24 |
...
| tank | hel f4 -> val d f30 | 37.7 / 36.7 | 0 | 0.68 | 0.73 | 0.68 | 0.42 | 324 | 0.33 |
...
| small_tower | hel f8 -> val b f249 | 19.1 / 27.2 | 36 | 0.72 | 0.75 | 0.58 | 0.61 | 35 | 0.72 |
| small_tower | hel f8 -> val c f164 | 19.1 / 31.0 | 53 | 0.73 | 0.69 | 0.40 | 0.60 | 67 | 0.66 |
| jet_plane | hel f4 -> val d f54 | 36.9 / 37.1 | 355 | 0.51 | 0.80 | 0.35 | 0.26 | 26 | 0.16 |
...
| large_tower | hel f9 -> val c f218 | 41.9 / 41.5 | 249 | 0.27 | 0.54 | 0.07 | 0.25 | 71 | 0.15 |
| large_launcher | hel f15 -> val d f200 | 32.1 / 32.3 | 347 | 0.24 | 0.73 | 0.10 | 0.13 | 62 | 0.03 |
| small_launcher | 6 pairs | 30 to 39 | 6 to 345 | 0.37 to 0.60 | 0.14 to 0.72 | 0.29 to 0.56 | 0.35 to 0.54 | | |
...
- Tank: the rotated tank has the barrel, the hull outline and the camouflage bands where B has them, at
  every one of the 8 large angles (76 to 285 degrees). Median NCC 0.62 across headings against 0.66 for
  the same heading at another image row and 0.42 for the best different class (jammer). The peak is sharp
  (0.32 to 0.42 elsewhere). In-plane rotation is a faithful augmentation for the tank.
...
- Large tower, validation b against c at the same view angle (36.1 and 36.9 degrees): the best angle is
  ...
  evidence. Helsinki against validation does not match at any angle (0.20 and 0.27 at 222 and 249 degrees,
  lean prediction 60 and 71): the helsinki tower is a light camouflaged lattice, the validation towers are
  black with an orange band, so this is a paint difference on top of the geometry.
- Large launcher: helsinki and validation track d are the same asset: long chassis, cab, canister, four
  outriggers, white stripe. The silhouettes agree (IoU 0.73) at 347 degrees, so the two scenes show it at
  nearly the same heading (13 degrees apart) and there is no heading change to test rotation on. Texture
  NCC is low (0.24) because the paint differs: light grey-green in helsinki (mean gray 106), dark green
...
- Jet plane: both scenes have the same heading (best angle 355). With the view angle matched the NCC is
  0.51 (IoU 0.80) although the paint differs (white in helsinki, grey with a dark nose in validation).
- Helicopter: thin rotor blades make NCC fragile (0.70 to 0.78 between neighbouring frames, 0.45 to 0.62
  ...
  stable over 12 pairs (60 to 72 degrees), so it is the heading difference, but the NCC is too low to call
  the match good: the rotor is at a different phase in the two tracks.
- Small launcher: a 12 to 15 px blob. The NCC curve is flat over angle (best elsewhere is within 0.07 of
...
|---|---|---|---|---|---|---|
| large_tower b -> c | 4 | 16, 28, 34, 60 | 31, 38, 48, 60 | 12.2 | 4 of 4 | 0.23 |
| small_tower b -> c | 5 | 14, 16, 16, 26, 28 | 24, 26, 27, 29, 32 | 9.5 | 5 of 5 | 0.78 |
...
| helicopter b -> b-early | 12 | 60 to 72 | 277 to 333 | 124.3 | 0 of 12 | 0.31 |
| small_launcher | 9 | flat curve | | 15.9 | 5 of 9 | 0.54 |

Large tower: the best angle rises from 16 to 60 degrees as the predicted lean turn rises from 31 to 60.
...
- Cast shadows: for each of 160 sprites I compared the mean gray of a 6 px band just outside the mask, in
  ...
  surroundings: no shadow. Over all sprites 16 have a sector below 0.80, and every group traces back to
  terrain next to one object seen in several frames (6 x the dark tree patch left of the helsinki jet,
...
- Bright side: a brightness plane fitted inside each mask explains 0 to 25 % of the gray variance for
  ...
  the object: 3.6, 16.6 and 10.6 degrees off for best angles of 16, 36 and 53 degrees, against 19.6, 19.4
  and 42.4 if it were fixed in the image.
...
|---|---|---|---|
| tank | 99.3 | 52.6 (tracks 44.4 to 59.0) | 1.9 |
| large_tower | 90.9 | 50.2 | 1.8 |
| jet_plane | 175.9 | 107.7 | 1.6 |
| large_launcher | 106.4 | 67.8 (track d) | 1.6 |
| mine_roller | 104.0 | 71.0 | 1.5 |
| small_tower | 177.6 | 125.2 | 1.4 |
| small_launcher | 174.5 | 129.5 | 1.3 |
| hangar | 10.2 | 13.9 | 0.7 |

For the tank the camouflage pattern is the same in both scenes (cross-scene NCC 0.60 to 0.68), so the
...
- If the generator knows where in the frame the window sits: rotate the sprite counter-clockwise by
  (azimuth of the paste position - sprite azimuth), within about +-15 degrees (the error measured in 2c),
...
|---|---|---|
| tank | full 360 | measured: 8 pairs at 76 to 285 degrees, NCC 0.50 to 0.68, same as view-angle-only change; angle constant per track pair over 12 pairs while the lean prediction moves |
...
| medium_plane | full 360 | 4 sprites from 4 consecutive helsinki frames, one heading, off-nadir 39 to 41 only; 0.72 to 0.75 between them; by analogy with the other planes: thin |
...
| helicopter | full 360 | angle constant (60 to 72) over 12 pairs, so orientation is the heading; NCC only 0.25 to 0.34 because of rotor phase; body is low: thin |
...
| large_launcher | lean rule, off-nadir matched within about 8 degrees; scenes may be mixed with brightness jitter | same asset in both scenes (IoU 0.73 at 347 degrees) with different paint; no second heading to test; top against bottom of the frame on validation track d drops to 0.24 (raised canister seen from the side at 36 degrees, from above at 3) |
| small_tower | lean rule (180 degree window) | 5 cross-track pairs follow the lean within 11 degrees (NCC 0.78); turns -14 with the view direction along its own helsinki track; nothing measured beyond 53 degrees |
| ta-ta | lean rule (180 degree window) | no second heading; side view at the top of the frame, back view at the bottom (0.46): thin |
| medium_launcher | lean rule, off-nadir matched | one track; top against bottom of the frame does not match (0.40 at -161 degrees) |
| large_tower | lean rule, off-nadir matched within 8 degrees, prefer the position-aware form | with matched view angle the best angle follows the lean on 4 of 4 validation pairs (16, 28, 34, 60 measured for 31, 38, 48, 60 predicted); along one track it turns -12 and +24 for predicted -22 and +30; NCC stays at 0.22 to 0.35, the chance level, so the evidence is the angle, not the score; near nadir it is a different picture; helsinki and validation towers differ in paint and do not match |
...
- Bank: tracks large-launcher-c2-080-105 and c-047-078 excluded (not launchers); validation large launcher
  ...
  the end wall stubs. Four validation tanks got their barrel back or were discarded. medium_plane has 4
  sprites (was 0). 169 sprites (was 156).
...
- Rewritten: the large launcher rows and bullets (2a, 2b, brightness 53.8 -> 67.8, section 4), the large
  tower bullets and table row, the hangar rows, the reference table, and the counts in section 3.
