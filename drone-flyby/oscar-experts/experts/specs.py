...
SPECS = {
    'helicopter': ClassSpec('helicopter', signatures=(rotor_lines, green_paint, camo_texture), competitors=('jammer', 'tank'), sift=True,
                            colour_blob=dict(probability=.3, min_fraction=.2, max_fraction=1.2), fine_templates=12, proposer_templates=12, scales=(1., 1.5, 2.), size_window=(.6, 2.6)),
    ...
    'jet_plane': ClassSpec('jet_plane', signatures=(bright_fraction, dark_fraction), competitors=('small_plane', 'condor', 'medium_plane'), sift=True, fine_templates=12, proposer_templates=12),
    ...
    'large_launcher': ClassSpec('large_launcher', signatures=(camo_texture, barrel_line), competitors=('tank', 'large_tower', 'mine_roller'), sift=True,
                                fine_templates=12, proposer_templates=12),
    ...
    'large_tower': ClassSpec('large_tower', signatures=(camo_texture, bright_fraction), competitors=('large_launcher', 'tank'), sift=True, fine_templates=12, proposer_templates=12, box_scales=()),
    ...
    'medium_plane': ClassSpec('medium_plane', signatures=(dark_fraction, green_paint), competitors=('small_plane', 'jet_plane'),
                              colour_blob=dict(probability=.35, min_fraction=.4, max_fraction=1.6), fine_templates=12, proposer_templates=12),
    ...
    'small_tower': ClassSpec('small_tower', signatures=(square_roof, green_paint, bright_fraction), competitors=('jammer', 'spacecraft'),
                             colour_blob=dict(probability=.35, min_fraction=.3, max_fraction=1.3), box_scales=()),
    ...
    'tank': ClassSpec('tank', signatures=(camo_texture, barrel_line), competitors=('mine_roller', 'small_tower', 'large_launcher'), fine_templates=12, proposer_templates=12),
}
