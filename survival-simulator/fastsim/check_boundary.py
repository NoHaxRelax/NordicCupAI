...
POLICY_FILES = ('../models/late_activation.hpp', '../models/self_stuck.hpp', POLICY_UNIT, '_orchard.hpp', '_evasion.hpp', 'policy_abi.hpp', 'policy_iface.hpp')
ALLOWED_LOCAL_INCLUDES = {'../models/late_activation.hpp', '../models/self_stuck.hpp', 'policy_abi.hpp', 'policy_iface.hpp', '_orchard.hpp', '_evasion.hpp',
                          '_shared_pysem.inc'}
