...
cp /Users/bumblebee/Github_repos/Projects/nordic-ai-cup-2026/survival/nightsim/{_nengine.cpp,_npolicy.hpp,__init__.py,build.py,run.py,escape.py,trapsite.py,guide.py,guide_dbg.py} $T/nightsim/
