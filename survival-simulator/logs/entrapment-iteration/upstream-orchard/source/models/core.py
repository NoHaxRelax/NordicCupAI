...
class EntrapmentPolicy:
    def __init__(self, seed=0):
        ...
        self.orchard = OrchardPolicy(seed=seed, **__import__('json').loads((__import__('pathlib').Path(__file__).parent / 'survival/oscar_best_config.json').read_text()))
        self.site = None
    ...
    def __call__(self, states_list, sim_time):
        ...
        for aid, s in states.items():
            ...
            if role not in ('explorer', 'gatherer'):
