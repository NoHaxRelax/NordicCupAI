...
def main():
 files=list((ROOT/'fastsim').glob('*.hpp'))+list((ROOT/'fastsim').glob('*.cpp'))+[ROOT/'models/self_stuck.hpp',ROOT/'scripts/rock320_config.py',ROOT/'scripts/rock320_worker.py',ROOT/'scripts/evaluate_frozen1000.py']
