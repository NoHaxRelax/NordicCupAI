        ...
        for group in self.groups:
            ...
            for aid in live:
                ...
                if station and aid in station['holders']:
                    ...
                    rails = [
                        add(add(face, mul(n, -90)), mul(tangent, -35)),
                        add(add(face, mul(n, -105)), mul(tangent, -35)),
                        add(add(face, mul(n, -105)), mul(tangent, 35)),
                        add(add(face, mul(n, -90)), mul(tangent, 35)),
                    ]
                    ...
                    inner = dot(sub(pose.p, face), n) >= -91.5
                    if worker['phase'] == 'approach':
                        target, speed, rule = rails[0], state['sprint_speed'], 'approach_temporary_holder'
                    ...
                    if len(live) == 1 and edges:
                        ...
                        rails = [
                            add(add(mid, mul(normal, 90)), mul(tangent, -35)),
                            add(add(mid, mul(normal, 105)), mul(tangent, -35)),
                            add(add(mid, mul(normal, 105)), mul(tangent, 35)),
                            add(add(mid, mul(normal, 90)), mul(tangent, 35)),
                        ]
                        inner = dot(sub(pose.p, mid), normal) <= 91.5
                        threats = [o for o in state['observations'] if o['type'] == 'Predator']
                        if threats:
                            worker['saw_threat'] = True
                        if worker['phase'] == 'approach':
