...
def run(*, depth=5., predators=3, interval=12., seconds=180., seed=301, gap=15.,
    ...
    tag = (f"depth{depth:g}-observed-gap-g{gap:g}-l{length:g}x{right_length:g}-o{face_offset:g}"
    ...
    recorder = ReplayRecorder(
        ...
        notes=(f"Bait depth={depth:g}; every simulation frame retained at0.1s with native rendering. " + __doc__ + f" Fixture places two native-sized obstacles with along-passage "
    ...
    result = dict(
        ...
        seed=seed, depth=depth, gap=gap, length=length, right_length=right_length,
