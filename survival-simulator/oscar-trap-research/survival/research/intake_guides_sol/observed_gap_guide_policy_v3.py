"""Observation-only far-mouth staging at a generalized predator-excluding gap.
...
the held predators' hearing radius, then holds for its incoming follower.
        ...
        for group in self.groups:
            ...
            for aid in live:
                ...
                if station:
                    ...
                    rule="stage_beyond_held_predator_hearing" if late else "sprint_into_observed_gap"
