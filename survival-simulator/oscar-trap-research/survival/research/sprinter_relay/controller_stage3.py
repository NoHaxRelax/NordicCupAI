...
class RelayController:
    ...
    def __call__(self,states,t):
        ...
        if self.active is not None and len(live)>1 and (self.variant!='orbit' or self.relay):
            ...
            candidates=[s for s in live if s['agent_id']!=self.active and s['energy']>=self.newborn_ready and (s['energy']>current['energy']+30 or (self.renew and current['age']>60 and s['age']<current['age']-20))]
