"""Frozen v15 development regressions; these are not held-out reliability cases."""
from pathlib import Path
import subprocess,sys,json
ROOT=Path(__file__).resolve().parents[2]
CASES=[(10029,9529),(10021,9421)]
rows=[]
for map_seed,fixture_seed in CASES:
 ...
 (ROOT/'results/simple_chase/probe-v15-execution.json').write_text(json.dumps({'cases':CASES,'executed':rows},indent=2)+'\n')
