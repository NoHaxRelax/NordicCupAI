...
class SimpleChase(RealMapGuidePolicy):
    ...
    def _select_site(self):
        ...
        if not sites:raise ValueError('no eligible replaceable bait site')
        # Preserve the tested centered approach where it has rear access;
        # boundary and offset sites expand support when that is unavailable.
