"""Reconstructed early v3 assignment wrapper for explicitly labelled reproductions.
Reverses the documented role-cap edit; no claim of an original wrapper snapshot.
