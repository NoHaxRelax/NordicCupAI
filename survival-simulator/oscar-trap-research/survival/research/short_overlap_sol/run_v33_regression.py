...
harness.OUT=ROOT/'results'/'short_overlap_sol'/'v33_regression'
if __name__=='__main__':
 ...
 path,result=harness.run(policy_spec='integrated_guide.policy_v33_adaptive_guard:Guide',map_seed=a.map_seed,fixture_seed=a.fixture_seed,seconds=300,predators=1,station_bait=True,native_render=True,native_width=320,mode='direct_guide')
