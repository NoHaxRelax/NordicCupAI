"""Run one frozen-v15 development regression into this track's results."""
import argparse
import json
...
harness.OUT = ROOT / "results" / "short_overlap_sol" / "v15_regression"
...
if __name__ == "__main__":
    ...
    path, result = harness.run(
        policy_spec="simple_chase.policy_v15_direct_escape:SimpleChase",
