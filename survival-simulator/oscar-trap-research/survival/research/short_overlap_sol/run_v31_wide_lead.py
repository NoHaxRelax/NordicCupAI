...
harness.OUT=ROOT/'results'/'short_overlap_sol'/'v31_wide_lead'
if __name__=='__main__':
 ...
 path,result=harness.run(policy_spec='short_overlap_sol.policy_v31_wide_lead:Guide',map_seed=a.map_seed,fixture_seed=a.fixture_seed,seconds=300,predators=1,station_bait=True,native_render=True,native_width=320,mode='direct_guide')
