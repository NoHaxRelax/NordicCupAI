...
class SimpleChase(RealMapGuidePolicy):
    def __init__(self, *args, **kwargs):
        ...
        self.runup = tuple(self.site['runup'])
...
# Cooperative inheritance keeps the frozen release behavior outside the guide
# implementation while making this file the complete integrated candidate.
from release_validation.release_mixin_v2 import ReleaseMixin
class ReleaseGuide(ReleaseMixin, SimpleChase):
    pass
