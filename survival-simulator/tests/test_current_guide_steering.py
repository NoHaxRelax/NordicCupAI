...
class SteeringTests(unittest.TestCase):
    ...
    def test_low_energy_cannot_request_sprint(self):
        ...
        self.assertTrue(debug['low_energy_walk_cap'])
        self.assertFalse(debug['sprint_selected'])
        self.assertEqual(debug['selected_move'], round(action['move_distance'], 3))
        self.assertEqual(debug['movement_cap'], 10.)
